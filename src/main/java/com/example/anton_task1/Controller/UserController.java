...
public class UserController {
    ...
    public ResponseEntity<FindResponse> getUserById(@PathVariable Long id) {
        ...
        try {
            ...
            ResponseEntity<FindResponse> response = new ResponseEntity<>(findResponse, headers, HttpStatus.OK);
            ...
            ResponseEntity<FindResponse> response = new ResponseEntity<>(findResponse, headers, HttpStatus.NOT_FOUND);
    ...
    public ResponseEntity<UpdateResponse> updateUser(@RequestBody UserDTO user) {
        ...
        try {
            ...
            ResponseEntity<UpdateResponse> response = new ResponseEntity<UpdateResponse>(updateResponse, headers, HttpStatus.OK);
            ...
            ResponseEntity<UpdateResponse> response = new ResponseEntity<UpdateResponse>(updateResponse, headers, HttpStatus.BAD_REQUEST);
    ...
    public ResponseEntity<DeleteResponse> deleteUserById(@PathVariable Long id) {
        ...
        ResponseEntity<DeleteResponse> response = new ResponseEntity<>(deleteResponse, headers, HttpStatus.OK);
